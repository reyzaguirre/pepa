...
- `r format(at[1, 5], digits = 4)` for genotypes `r if(at[1, 5] < 0.05) {"which is significant at the 5% level."}` `r if(at[1, 5] > 0.05) {"which is not significant at the 5% level."}`
- `r format(at[2, 5], digits = 4)` for environments `r if(at[2, 5] < 0.05) {"which is significant at the 5% level."}` `r if(at[2, 5] > 0.05) {"which is not significant at the 5% level."}`
- `r format(at[4, 5], digits = 4)` for the genotypes by environments interaction `r if(at[4, 5] < 0.05) {"which is significant at the 5% level."}` `r if(at[4, 5] > 0.05) {"which is not significant at the 5% level."}`
