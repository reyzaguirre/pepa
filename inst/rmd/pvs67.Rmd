...
```{r echo = FALSE}
ft <- with(data, friedman(PanelNo, INSTN, Appe, group = TRUE)) 
ft$statistics
ft$groups
ft <- with(data, friedman(PanelNo, INSTN, Appe, group = FALSE)) 
ft$comparison
```
...
```{r echo = FALSE}
ft <- with(data, friedman(PanelNo, INSTN, Tast, group = TRUE)) 
ft$statistics
ft$groups
ft <- with(data, friedman(PanelNo, INSTN, Tast, group = FALSE)) 
ft$comparison
```
...
```{r echo = FALSE}
ft <- with(data, friedman(PanelNo, INSTN, Text, group = TRUE)) 
ft$statistics
ft$groups
ft <- with(data, friedman(PanelNo, INSTN, Text, group = FALSE)) 
ft$comparison
```
