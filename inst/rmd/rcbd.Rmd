...
There are data from `r length(unique(data[, geno]))` genotypes evaluated using a randomize complete block design with `r length(unique(data[, rep]))` blocks. The statistical model is
$$
