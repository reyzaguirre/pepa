...
```{r echo = FALSE}
ft <- with(data, friedman(REP, INSTN, Men, group = TRUE)) 
ft$statistics
ft$groups
ft <- with(data, friedman(REP, INSTN, Men, group = FALSE)) 
ft$comparison
```
...
```{r echo = FALSE}
ft <- with(data, friedman(REP, INSTN, Women, group = TRUE)) 
ft$statistics
ft$groups
ft <- with(data, friedman(REP, INSTN, Women, group = FALSE)) 
ft$comparison
```
...
```{r echo = FALSE}
ft <- with(data, friedman(REP, INSTN, Global, group = TRUE)) 
ft$statistics
ft$groups
ft <- with(data, friedman(REP, INSTN, Global, group = FALSE)) 
ft$comparison
```
