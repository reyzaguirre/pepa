...
```{r, echo = FALSE}
lc <- check.AxB(traits[i], geno, env, rep, data)
if (lc$c3 == 0)
...
`r if (at[4, 5] > 0.05 | lc$c1 == 0 | lc$nb <= 2) {"This analysis is not shown because:"}`
...
`r if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {"Because interaction is significant a stability analysis is presented."}`

`r if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {paste("### ", {{i+1}}, ".3.1. AMMI", sep = "")}`

`r if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {"#### AMMI biplots"}`

```{r, echo = FALSE, fig.align = 'center', fig.width = 8, fig.height = 8}
if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {
...
`r if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {"#### Interaction effects"}`
```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) ammimodel$Interaction_effects
```

`r if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {"#### PC-values for genotypes"}`

```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) ammimodel$PC_values_genotypes
```

`r if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {"#### PC-values for environments"}`

```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) ammimodel$PC_values_environments
```

`r if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {"#### PC contributions"}`

```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) ammimodel$Contribution_PCs
```

`r if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {paste("### ", {{i+1}}, ".3.2. GGE", sep = "")}`

`r if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {"#### GGE biplots"}`
...
```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) ggemodel$PC_values_genotypes
```

`r if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {"#### PC-values for environments"}`

```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) ggemodel$PC_values_environments
```

`r if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {"#### PC contributions"}`

```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) ggemodel$Contribution_PCs
```

`r if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {paste("### ", {{i+1}}, ".3.3. Regression Stability Analysis", sep = "")}`
...
`r if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {"#### ANOVA"}`

```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) rsamodel$ANOVA
```

`r if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {"#### Stability measures for genotypes"}`

```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) rsamodel$Stability_for_genotypes
```

`r if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {"Here: \n
...
`r if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {"#### Stability measures for environments"}`

```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) rsamodel$Stability_for_environments
```

`r if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {paste("### ", {{i+1}}, ".3.4. Tai stability analysis", sep = "")}`

`r if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {"#### Tai plot"}`
...
`r if (at[4, 5] < 0.05 & lc$c1 == 1 & lc$nb > 2) {"#### Tai alpha and lambda values"}`
