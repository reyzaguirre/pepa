...
```{r, echo = FALSE}
lc <- ck.f(traits[i], c(geno, env), rep, data)
if (lc$c4 == 0)
...
h2 <- vg / (vg + vgxe / lc$nl[2] + vr / lc$nl[2] / lc$nr) * 100
vc
```
...
`r if (at[4, 5] < 0.05 & lc$nl[2] > 2) {paste("### ", {{i+1}}, ".3.1. AMMI", sep = "")}`
...
```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$nl[2] > 2) ammimodel$Interaction_effects
```

`r if (at[4, 5] < 0.05 & lc$nl[2] > 2) {"#### PC-values for genotypes"}`

```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$nl[2] > 2) ammimodel$PC_values_genotypes
```

`r if (at[4, 5] < 0.05 & lc$nl[2] > 2) {"#### PC-values for environments"}`

```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$nl[2] > 2) ammimodel$PC_values_environments
```

`r if (at[4, 5] < 0.05 & lc$nl[2] > 2) {"#### PC contributions"}`

```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$nl[2] > 2) ammimodel$Contribution_PCs
```

`r if (at[4, 5] < 0.05 & lc$nl[2] > 2) {paste("### ", {{i+1}}, ".3.2. GGE", sep = "")}`
...
```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$nl[2] > 2) ggemodel$PC_values_genotypes
```

`r if (at[4, 5] < 0.05 & lc$nl[2] > 2) {"#### PC-values for environments"}`

```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$nl[2] > 2) ggemodel$PC_values_environments
```

`r if (at[4, 5] < 0.05 & lc$nl[2] > 2) {"#### PC contributions"}`

```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$nl[2] > 2) ggemodel$Contribution_PCs
```

`r if (at[4, 5] < 0.05 & lc$nl[2] > 2) {paste("### ", {{i+1}}, ".3.3. Regression Stability Analysis", sep = "")}`
...
```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$nl[2] > 2) rsamodel$ANOVA
```

`r if (at[4, 5] < 0.05 & lc$nl[2] > 2) {"#### Stability measures for genotypes"}`

```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$nl[2] > 2) rsamodel$Stability_for_genotypes
```
...
```{r, echo = FALSE}
if (at[4, 5] < 0.05 & lc$nl[2] > 2) rsamodel$Stability_for_environments
```

`r if (at[4, 5] < 0.05 & lc$nl[2] > 2) {paste("### ", {{i+1}}, ".3.4. Tai stability analysis", sep = "")}`
