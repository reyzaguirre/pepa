...
`r if (all(is.na(harv$Criteria))) {"There were no data for selection criteria at flowering."}`
...
`r if (all(is.na(stor$Criteria))) {"There were no data for selection criteria at flowering."}`
