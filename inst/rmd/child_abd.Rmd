...
model_dau <- aov(data[, traits[i]] ~ data[, geno] + data[, rep])
model_dau$terms[[2]] <- traits[i]
at <- anova(model_dau)
rownames(at)[1] <- geno 
```
...
You have fitted a linear model for a Augmented Block Design (ABD). The ANOVA table for your model is:
