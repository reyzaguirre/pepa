...
if (max(check$tfreq) > 0 & check$c4 == 1) {
  ft <- with(data, friedman(REP, INSTN, MSM, group = TRUE))
  ft$statistics
  ft$groups
  ft <- with(data, friedman(REP, INSTN, MSM, group = FALSE))
  ft$comparison
}
```
...
if (max(check$tfreq) > 0 & check$c4 == 1) {
  ft <- with(data, friedman(REP, INSTN, MSWM, group = TRUE))
  ft$statistics
  ft$groups
  ft <- with(data, friedman(REP, INSTN, MSWM, group = FALSE))
  ft$comparison
}
```
...
if (max(check$tfreq) > 0 & check$c4 == 1) {
  ft <- with(data, friedman(REP, INSTN, MSGLO, group = TRUE))
  ft$statistics
  ft$groups
  ft <- with(data, friedman(REP, INSTN, MSGLO, group = FALSE))
  ft$comparison
}
```
...
if (max(check$tfreq) > 0 & check$c4 == 1) {
  ft <- with(data, friedman(REP, INSTN, BSM, group = TRUE))
  ft$statistics
  ft$groups
  ft <- with(data, friedman(REP, INSTN, BSM, group = FALSE)) 
  ft$comparison
}
```
...
if (max(check$tfreq) > 0 & check$c4 == 1) {
  ft <- with(data, friedman(REP, INSTN, BSWM, group = TRUE))
  ft$statistics
  ft$groups
  ft <- with(data, friedman(REP, INSTN, BSWM, group = FALSE))
  ft$comparison
}
```
...
if (max(check$tfreq) > 0 & check$c4 == 1) {
  ft <- with(data, friedman(REP, INSTN, BSGLO, group = TRUE))
  ft$statistics
  ft$groups
  ft <- with(data, friedman(REP, INSTN, BSGLO, group = FALSE))
  ft$comparison
}
```
