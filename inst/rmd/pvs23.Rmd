...
The genotypes have been planted in `r nrb` baby plots. At each baby plot the complete set of genotypes is planted. A group of men and women voted independently for the best genotypes at each baby plot.
...
Here all the votes on the mother and baby plots are pooled together.
