...
if (at[1, 5] < 0.05)
  agricolae::LSD.test(dfr[, trait.est], dfr[, trt], at[3, 1], at[3, 3])$groups
...
if (at[1, 5] < 0.05)
  agricolae::HSD.test(dfr[, trait.est], dfr[, trt], at[3, 1], at[3, 3])$groups
