...
```{r echo = FALSE}
if (at[1, 5] < 0.05)
  agricolae::LSD.test(dfr[, traits[i]], dfr[, geno], at[3, 1], at[3, 3])$groups
```
...
```{r echo = FALSE}
if (at[1, 5] < 0.05)
  agricolae::HSD.test(dfr[, traits[i]], dfr[, geno], at[3, 1], at[3, 3])$groups
```

```{r echo = FALSE}
if (at[1, 5] > 0.05)
    tapply(dfr[, traits[i]], dfr[, geno], mean)
```
