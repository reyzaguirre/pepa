...
at <- suppressWarnings(st4gi::rcbd(trait, treat, rep, data, maxp))
if (lc$c3 == 0)
...
`r if(at[1, 5] < 0.05) {"which is significant at the 5% level."}`
`r if(at[1, 5] > 0.05) {"which is not significant at the 5% level."}`
